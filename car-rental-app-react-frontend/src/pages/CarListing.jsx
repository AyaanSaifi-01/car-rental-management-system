  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        if (!user) {
          setCars(mockCars);
          setApiError('Login as Customer to load cars from MySQL. Showing sample cars.');
          return;
        }
        ...
        setCars(mockCars);
        setApiError(err.message || 'Backend not reachable on :1571. Showing sample cars.');
      } finally {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1">
          {loading ? (
            <div className="text-center py-20 text-gray-500">Loading from database...</div>
          ) : (
          ...
          {!loading && filtered.length === 0 && (
            <div className="text-center py-20 text-gray-500">
              ...
              <p className="text-sm mt-2">Login as Car Owner and register cars first.</p>
            </div>
          )}
        </div>
      </div>
