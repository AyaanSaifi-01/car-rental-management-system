            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="date" value={pickupDate} onChange={(e) => setPickupDate(e.target.value)} className="input-field pl-9 text-sm" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                  <input type="date" value={returnDate} onChange={(e) => setReturnDate(e.target.value)} className="input-field pl-9 text-sm" />
                </div>
              </div>
          ...
          {popularCars.map((car) => (
            <div key={car.id} className="card group hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-4">
                ...
                <Link to={`/cars/${car.id}`} className="mt-4 block btn-primary text-center text-sm py-2">
                  Book Now
                </Link>
              </div>
            </div>
